...
public:
	...
	std::string qcoind_authorization;
	std::string qcoind_authorization_private;
	uint16_t qcoind_bind_port;
	std::string qcoind_bind_ip;
	uint16_t qcoind_remote_port = 0;
	std::string qcoind_remote_ip;
