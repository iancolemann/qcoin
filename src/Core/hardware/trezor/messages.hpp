...
enum MessageType {
	...
	MessageType_qCoinEmptyResponse                     = 800,
	MessageType_qCoinStartRequest                      = 801,
	MessageType_qCoinStartResponse                     = 802,
	MessageType_qCoinScanOutputsRequest                = 803,
	MessageType_qCoinScanOutputsResponse               = 804,
	MessageType_qCoinGenerateKeyimageRequest           = 805,
	MessageType_qCoinGenerateKeyimageResponse          = 806,
	MessageType_qCoinGenerateOutputSeedRequest         = 807,
	MessageType_qCoinGenerateOutputSeedResponse        = 808,
	MessageType_qCoinExportViewWalletRequest           = 809,
	MessageType_qCoinExportViewWalletResponse          = 810,
	MessageType_qCoinSignStartRequest                  = 811,
	MessageType_qCoinSignAddInputRequest               = 813,
	MessageType_qCoinSignAddOutputRequest              = 815,
	MessageType_qCoinSignAddOutputResponse             = 816,
	MessageType_qCoinSignAddExtraRequest               = 817,
	MessageType_qCoinSignStepARequest                  = 819,
	MessageType_qCoinSignStepAResponse                 = 820,
	MessageType_qCoinSignStepAMoreDataRequest          = 821,
	MessageType_qCoinSignGetC0Request                  = 823,
	MessageType_qCoinSignGetC0Response                 = 824,
	MessageType_qCoinSignStepBRequest                  = 825,
	MessageType_qCoinSignStepBResponse                 = 826,
	MessageType_qCoinStartProofRequest                 = 827
};
