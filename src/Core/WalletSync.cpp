...
WalletSync::WalletSync(logging::ILogger &log, const Config &config, WalletState &wallet_state,
    ...
    , m_sync_agent(config.qcoind_remote_ip,
          config.qcoind_remote_port ? config.qcoind_remote_port : config.qcoind_bind_port)
    , m_commands_agent(config.qcoind_remote_ip,
          config.qcoind_remote_port ? config.qcoind_remote_port : config.qcoind_bind_port)
...
void WalletSync::send_get_status() {
	...
	req_header.r.basic_authorization = m_config.qcoind_authorization;
